...
export const APP_URL = 'https://blurt.buzz/';
export const APP_DOMAIN = 'blurt.buzz';
...
export const LANDING_PAGE_URL = 'https://blurt.buzz/';
...
export const RECOMMENDED_FOLLOW_ACCOUNT = 'blurt.buzz';
